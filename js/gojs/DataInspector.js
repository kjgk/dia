...
Inspector.prototype.buildPropertyRow = function (propertyName, propertyValue) {
  ...
  td1.textContent = decProp && decProp.label || propertyName;
  tr.appendChild(td1);
...
Inspector.prototype.updateSelect = function (decProp, select, propertyName, propertyValue) {
  ...
  for (var i = 0; i < choices.length; i++) {
    ...
    if (choice instanceof Object && choice.id) {
  ...
  if (propertyValue instanceof Object && propertyValue.id) {
    select.value = propertyValue.id;
  } else
